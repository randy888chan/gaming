...
// Use dynamic imports with lazy loading for better code splitting
const DiceGame = dynamic(() => import("./Dice"), { ssr: false, loading: () => <div>Loading Dice...</div> });
const SlotsGame = dynamic(() => import("./Slots"), { ssr: false, loading: () => <div>Loading Slots...</div> });
const FlipGame = dynamic(() => import("./Flip"), { ssr: false, loading: () => <div>Loading Flip...</div> });
const HiLoGame = dynamic(() => import("./HiLo"), { ssr: false, loading: () => <div>Loading HiLo...</div> });
const MinesGame = dynamic(() => import("./Mines"), { ssr: false, loading: () => <div>Loading Mines...</div> });
const RouletteGame = dynamic(() => import("./Roulette"), { ssr: false, loading: () => <div>Loading Roulette...</div> });
const PlinkoGame = dynamic(() => import("./Plinko"), { ssr: false, loading: () => <div>Loading Plinko...</div> });
const CrashGame = dynamic(() => import("./Crash"), { ssr: false, loading: () => <div>Loading Crash...</div> });
const LimboGame = dynamic(() => import("./Limbo"), { ssr: false, loading: () => <div>Loading Limbo...</div> });
const KenoGame = dynamic(() => import("./Keno"), { ssr: false, loading: () => <div>Loading Keno...</div> });
