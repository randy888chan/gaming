...
export class CrossChainSettlementService {
    ...
    constructor(
        ...
        this.signer = signer;
        this.contract = CrossChainSettlement__factory.connect(contractAddress, signer);
    }

    public async initiateSwap(amount: ethers.BigNumber, targetChain: string): Promise<string> {
    ...
    public async getSwapDetails(swapId: string): Promise<CrossChainSettlement.SwapStructOutput> {
