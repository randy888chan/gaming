...
export default function Header() {
  ...
  return (
    <>
      <div className="flex items-center justify-between w-full p-2.5 bg-gradient-to-b from-blue-800 rom-black to-indigo-700 fixed top-0 left-0 z-50 rounded-b-2xl shadow-lg">
