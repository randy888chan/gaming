...
describe("ZetaChainSettlement", () => {
  ...
  beforeEach(() => {
    ...
    settlement = new ZetaChainSettlement(
      rpcUrl,
      privateKey,
      contractAddress,
      contractAbi
  ...
  describe("settleMarket", () => {
    it("should successfully settle a market and return transaction hash", async () => {
    ...
    it("should retry on specific transaction errors and eventually succeed", async () => {
      // Increased timeout for this test
    ...
    it("should throw an error if all retries fail", async () => {
      ...
      await expect(
        settlement.settleMarket(marketId, outcome, amount)
      ).rejects.toThrow(
    ...
    it("should throw an error if transaction confirmation times out", async () => {
      ...
      (settlement as any).confirmTransaction = jest
        .fn()
      ...
      expect((settlement as any).confirmTransaction).toHaveBeenCalledWith(
        mockTxHash
      );
