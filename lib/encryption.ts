...
let ENCRYPTION_KEY = process.env.ENCRYPTION_KEY || 'a_very_secret_key_of_32_chars_long'; // Use a strong, randomly generated key in production

if (ENCRYPTION_KEY.length !== 32) {
  console.warn('ENCRYPTION_KEY is not 32 bytes long. Please generate a strong 32-byte key for production.');
